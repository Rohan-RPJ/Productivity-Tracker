...
#        json.dumps(self.activities)
    ...
    def activities_to_json(self,activity):
        ...
        if new_window_name == 'Mozilla Firefox' or new_window_name == 'Google Chrome':
            ...
            #print("Tim Entries:", activity.time_entries, "of ",activity.name)
        return activities_
...
class WinActivity:
    ...
    def serialize(self):
        ...
        print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
        print(self.name)
        #print("Self time entries:",self.make_time_entires_to_json())
        print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
    ...
    def serialize_browser(self, new_window_name):
        ...
        if new_window_name == 'Mozilla Firefox':
            data['activities'][1]['WEBSITE TRACKING']['Mozilla Firefox'].update({
                (self.name.split(' - ')[0]) : {'time_entries' : self.make_time_entires_to_json()}
            })
    ...
    def make_time_entires_to_json(self):
        ...
        #print("TimeList length: ",len(time_list))
        return time_list
